...
import { LineSeriesConfig } from '@data-studio/component/standard/lib/chart/echart.interface/series/line.series';
...
@Component({
  selector: 'app-line-series-config',
  templateUrl: './line.series.config.component.html',
