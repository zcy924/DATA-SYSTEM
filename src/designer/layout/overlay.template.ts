...
<div class="m-overlay  bottom"
  ...
  <div class="m-classMenu " style="zoom: 1;">
    ...
    <ul class="btns-box">
      ...
      <li class="btn-item draggable" draggable="true" data-component-name="standard$text.graphic">
        <div class="u-tool-btn">
      ...
      <li class="btn-item draggable" draggable="true" data-component-name="standard$comment.graphic">
        <div class="u-tool-btn">
...
<div class="m-overlay  bottom" style="display:none; z-index: 406; position: absolute; top: 68px; left: 342px;">
  ...
  <div class="m-classMenu m-classMenu-more" style="zoom: 1;">
    ...
    <ul class="btns-box">
    <li class="btn-item draggable" draggable="true" data-component-name="standard$line.chart.graphic">
        <div class="u-tool-btn">
          <i class="u-icn u-icn-chart-line"></i>
          <span class="text">折线图</span>
        </div>
      </li>
      <li class="btn-item draggable" draggable="true" data-component-name="custom$clock.graphic">
        <div class="u-tool-btn">
          <i class="u-icn u-icn-chart-area"></i>
          <span class="text">区域图</span>
        </div>
      </li>
      <li class="btn-item draggable" draggable="true" data-component-name="standard$pie.chart.graphic">
        <div class="u-tool-btn">
