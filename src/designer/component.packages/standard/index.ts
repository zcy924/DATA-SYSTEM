...
import { TextGraphic } from './auxiliary/text.graphic';
import { CommentGraphic } from './auxiliary/comment.graphic';
import { ImageGraphic } from './auxiliary/image.graphic';
import { ClockGraphic } from '../custom/clock.graphic';
import { FlipBarChartGraphic } from './chart/flip.bar.chart.graphic';
import { TableGraphic } from '../custom/table.graphic';
import { MapChartGraphic } from './chart/map.chart.graphic';
import { WordCloudChartGraphic } from './chart/word.cloud.chart.graphic';
...
compRepo.batchRegister([
  ...
  },
  {
    ...
    graphicDef: LineChartGraphic,
  },
  {
    key: 'pie.chart.graphic',
    componentOption: {
      region: {
        regionKey: 'explicit.region',
      },
  ...
  },
  {
    ...
    componentOption: {
      ...
      graphic: {
        graphicKey: 'flip.bar.chart.graphic',  // FlipBarChartGraphic
        configOption: null,
        dataSourceKey: 'num1',
      },
    },
    graphicDef: FlipBarChartGraphic,
  },
  {
  ...
  },
  {
    ...
    graphicDef: WordCloudChartGraphic,
  },
  {
    key: 'demo',
    paletteMeta: {
